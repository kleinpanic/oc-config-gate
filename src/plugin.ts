...
import type { OpenClawPluginApi, OcConfigGatePluginConfig } from "./types.js";
...
export default definePluginEntry({
  ...
  register(api: unknown): void {
    const gateApi = api as OpenClawPluginApi;
    const rawCfg = (gateApi.pluginConfig ?? {}) as OcConfigGatePluginConfig;
    ...
    gateApi.registerInteractiveHandler({
      ...
      handler: async (ctx) => {
        ...
        const [action, requestId] = ctx.interaction.payload.split(":") as [string, string?];
